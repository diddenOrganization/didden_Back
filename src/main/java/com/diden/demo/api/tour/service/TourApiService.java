...
public interface TourApiService {
  Slice<TourCommonV4ResponseDto> pageSlice(
      Pageable pageable,
  ...
  TourEntitySupportResponseInterface tourDetail(ServiceContentTypeCode serviceContentTypeCode, Long contentId) throws Throwable;
}
