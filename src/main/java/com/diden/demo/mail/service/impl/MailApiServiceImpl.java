...
public class MailApiServiceImpl implements MailApiService {
    ...
    public void sendMail(String to, String from, int authKey) throws MessagingException, UnsupportedEncodingException{
        ...
        try{
            ...
            log.info("Email Send to : "+to+" from :"+from+" subject :"+subject+" content :"+content.toString());
        }catch (MessagingException e){
            log.info("[MessagingException] = ", e.getMessage());
