 ...
 * (서비스키) - 필수값 listYN 목록 구분 - Y 목록 출력, N Total 카운트 값 출력 arrange 정렬 구분 contentTypeId 관광타입 ID
 * areaCode 지역코드 sigunguCode 시군구코드 cat1 대분류 cat2 중분류 cat3 소분류 modifiedtime 수정일
 *
