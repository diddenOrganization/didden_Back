package com.diden.demo.domain.user.vo.response;
...
@Getter
@ToString
public class UserSocialSignUpVo {
  ...
  @Builder
  public UserSocialSignUpVo(AccountTypeEnum loginType, String accessToken, String refreshToken) {
